    ...
    <form method="post" enctype="multipart/form-data" action="{{ route('companies.update', $company) }}">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name"
                   aria-describedby="nameHelp" value="{{ old('name') ?? $company->name }}" required>
            @error('name')
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control @error('website') is-invalid @enderror" id="website" name="website"
                   aria-describedby="websiteHelp" value="{{ old('website') ?? $company->website }}">
            @error('website')
        ...
        <div class="form-group form-check">
            ...
            <label class="form-check-label" for="remove_logo">Delete current logo</label>
        </div>
        <div class="form-group">
